...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Error while adding students: " + e.getMessage());
        }
        ...
        try {
            System.out.println("\n********* List data of students after removal **********");
            for (Student s : students) {
            ...
            System.err.println("Error while displaying student data: " + e.getMessage());
        }
